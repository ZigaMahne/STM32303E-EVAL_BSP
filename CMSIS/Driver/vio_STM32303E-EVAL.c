/******************************************************************************
 * @file     vio_STM32303E-EVAL.c
 * @brief    Virtual I/O implementation for board STM32303E-EVAL
 * @version  V1.0.0
 * @date     17. April 2025
 ******************************************************************************/
/*
...
/*! \page vio_STM32303E-EVAL Physical I/O Mapping

The table below lists the physical I/O mapping of this CMSIS-Driver VIO implementation.

| Virtual I/O   | Variable       | Board component      | Pin
|:--------------|:---------------|:---------------------|:------
| vioBUTTON0    | vioSignalIn.0  | USER button (B2)     | PE6
| vioLED0       | vioSignalOut.0 | LED red     (LD3)    | PE10
| vioLED1       | vioSignalOut.1 | LED green   (LD1)    | PE8
| vioLED2       | vioSignalOut.2 | LED blue    (LD4)    | PE11
| vioLED3       | vioSignalOut.3 | LED orange  (LD2)    | PE9
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTE(10), ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED1,    GPIO_PIN_ID_PORTE(8),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED2,    GPIO_PIN_ID_PORTE(11), ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED3,    GPIO_PIN_ID_PORTE(9),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW }
};
#endif
...
//  signal,     pin,                   pull resistor,      active state
  { vioBUTTON0, GPIO_PIN_ID_PORTE(6),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW }
};
#endif
